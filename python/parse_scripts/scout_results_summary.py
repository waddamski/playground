...
def parse_options():
    ...
    parser.add_argument("file", help='the name of the input file')
    parser.add_argument("awsprofile", help="the name of your aws_cli profile - generally ds-prod or ds-nonprod")
...
def main():
    ...
    if matched_function is None:
        ...
        results, out_file = eval(matched_function)(file_name)
